...
FILE_A_ID = "1_SEziSRFL6_UC1WyfbyZFv3FZ73zBZL-"  # Main CSV file
FILE_B_ID = "1SXcLm1hhzQK23XY6Qt7E1YX5Fa-2Tlr9"  # SERP templates JSON file
FILE_C_ID = "1v_MvK2aiUKZWSx4zRs_eA20L7BYt82Sc"  # File C - Creative requests (creative_id, Creative_Size_Final, request) - UPDATE THIS
